...
import {IMINTYToken} from "../interfaces/IMINTYToken.sol";

/**
 * @title TokenDistributor
 * @notice It handles the distribution of IMINTY token.
 * It auto-adjusts block rewards over a set number of periods.
 */
contract TokenDistributor is ReentrancyGuard {
    using SafeERC20 for IERC20;
    using SafeERC20 for IMINTYToken;
    ...
    IMINTYToken public immutable IMINTYRareToken;
    ...
    /**
     * @notice Constructor
     * @param _IMINTYRareToken IMINTY token address
    ...
    constructor(
        ...
        uint256 nonCirculatingSupply = IMINTYToken(_IMINTYRareToken)
            .SUPPLY_CAP() - IMINTYToken(_IMINTYRareToken).totalSupply();
        ...
        // 2. Store values
        IMINTYRareToken = IMINTYToken(_IMINTYRareToken);
     ...
     * @param amount amount to deposit (in IMINTY)
     */
    function deposit(uint256 amount) external nonReentrant {
        ...
        // Transfer IMINTY tokens to this contract
        IMINTYRareToken.safeTransferFrom(msg.sender, address(this), amount);
    ...
    function withdraw(uint256 amount) external nonReentrant {
        ...
        // Transfer IMINTY tokens to the sender
        IMINTYRareToken.safeTransfer(msg.sender, amount);
    ...
    function withdrawAll() external nonReentrant {
        ...
        // Transfer IMINTY tokens to the sender
        IMINTYRareToken.safeTransfer(msg.sender, amountToTransfer);
    ...
    function _updatePool() internal {
        ...
        if (tokenRewardForStaking > 0) {
            ...
            bool mintStatus = IMINTYRareToken.mint(
                address(this),
            ...
            IMINTYRareToken.mint(tokenSplitter, tokenRewardForOthers);
        }
